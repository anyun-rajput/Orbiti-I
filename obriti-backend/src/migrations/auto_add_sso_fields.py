"""
Automatic database migration script to add Microsoft SSO fields to existing users table.
This script runs without user confirmation for automated deployment.
"""
